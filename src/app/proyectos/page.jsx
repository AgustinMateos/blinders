        ...
        {currentProjects.map((project) => (
          <Link key={project.id} href={`/proyectos/${selectedCategory}/${project.id}`}>
            ...
            >
              ...
              {/* Project title */}
              <p className="absolute font-dm-mono bottom-[80px] md:bottom-[80px] left-3 right-0 text-amber-50 py-2 z-10" >
                {project.tipo}
              </p>
              <p className="absolute  bottom-[30px] left-3 right-0 font-archivo text-[#FFFFFF] text-[24px] leading-[100%] tracking-[0] py-2 z-10 " style={{fontWeight:'700px'}}>
                {project.title}
              </p>
